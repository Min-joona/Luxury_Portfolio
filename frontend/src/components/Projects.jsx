            ...
            >
              <Link to={`/projects/${project.slug}`} className="group block">
                ...
                <div className={`relative aspect-[4/3] rounded-xl overflow-hidden mb-6 ${
                  ...
                  {(() => {
                    const cUrl = project.cover || project.videos?.[0] || project.images?.[0] || project.image;
                    const isVid = project.cover ? project.videos?.includes(project.cover) : !!project.videos?.length;
                    return isVid ? (
                    <div className="w-full h-full relative">
                      <video src={cUrl} muted loop playsInline className="w-full h-full object-cover" />
